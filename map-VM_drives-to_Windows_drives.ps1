write-host "This scrpt will map Windows drives to VM SCSI drives"

U:\connect-vcenter.ps1
""
""
$VMname = read-host "Enter VM name as it is in vCenter server"
$CompName = Read-Host "Enter AD computer name"

#Add-PSSnapin "Vmware.VimAutomation.Core" 
#Connect-VIServer -Server m4ukvc05
...
$Disks = Get-WmiObject -Class Win32_DiskDrive -ComputerName $CompName
